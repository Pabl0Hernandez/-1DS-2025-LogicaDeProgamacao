...
if (anoNascimento > 2000) {
  ...
  console.log("A pessoa naceu em 2000 ou antes");
}
...
if (semaforo == "verde") {
  console.log("Siga");
} else if (semaforo == "amarelo") console.log("Atenção");
else {
  console.log("Pare!");
}
...
var preco = 500;
var resultado = preco <= 100 ? "Tá barato1" : "Vish, ta muito caro!";
