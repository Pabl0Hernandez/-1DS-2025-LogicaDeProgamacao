...
console.log("20ª posição:", dinos[19]); //quando não temos o item, aprenta um erro (undefined)
...
dinos.splice(1, 1); //Remove o elemento de índice 1 (a partir da posição 1, exclui 1 elementos)
console.table(dinos);
...
// Criando um array númerico
var numeros = [4, 3, 1, 9, 7, 2];
console.table(numeros);

// Imprimindo os elementos da posições ímpares
...
var híbrido = [10, "Pafúncio", 3.45, "Zuleika", 7];
console.table(híbrido);
...
// Obtando elemento com base em seus índices
